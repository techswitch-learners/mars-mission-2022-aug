...
=======
    detail: "The month March was also named after him. Mars's moons, called Phobos and Deimos, are named after the gods of fear.",
  },
  {
    id: 2,
    prompt: "A year on Mars is not the same as on Earth.",
